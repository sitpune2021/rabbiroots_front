      ...
      <div className="w-full relative">
        ...
        >
          {allProducts.map((items, idx) => (
            <SwiperSlide key={items.id || idx} className="h-auto">
              <Link to={`/showitem/${items.globalId}`} className="block h-full">
                <ProductDesign item={items} />
              </Link>
            </SwiperSlide>
          ))}
        </Swiper>
